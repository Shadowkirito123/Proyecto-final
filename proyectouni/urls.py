...
urlpatterns = [
    ...
    path('enviar_mensaje/<int:emisor_id>/', views.enviar_mensaje, name='enviar_mensaje'),
    path('enviar_mensaje_profe/<int:estudiante_id>/', views.enviar_mensaje_profesor, name='enviar_mensaje_alumno'),
